...
echo "cp lib"
sudo cp ./rknpu2_1.4.0_20220909/runtime/RK3588/Linux/librknn_api/aarch64/* /usr/lib
echo "cp bin"
sudo cp ./rknpu2_1.4.0_20220909/runtime/RK3588/Linux/rknn_server/aarch64/usr/bin/* /usr/bin/
